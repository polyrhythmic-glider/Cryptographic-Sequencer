{
    "patcher": {
        ...
        "boxes": [
            ...
            {"box": {"id": "obj-2", "maxclass": "newobj", "text": "js cryptoseq_ui.js", "numinlets": 1, "numoutlets": 9, "outlettype": ["", "", "", "int", "", "", "", "", ""], "patching_rect": [30.0, 70.0, 130.0, 22.0]}},
            ...
            {"box": {"id": "obj-20", "maxclass": "umenu", "varname": "cs_root_menu", "numinlets": 1, "numoutlets": 3, "outlettype": ["int", "", ""], "patching_rect": [755.0, 42.0, 75.0, 22.0]}},
            {"box": {"id": "obj-21", "maxclass": "comment", "varname": "cs_root_label", "text": "root note", "numinlets": 1, "numoutlets": 0, "patching_rect": [755.0, 18.0, 75.0, 20.0]}},
            ...
            {"box": {"id": "obj-28", "maxclass": "umenu", "varname": "cs_scale_menu", "numinlets": 1, "numoutlets": 3, "outlettype": ["int", "", ""], "patching_rect": [965.0, 42.0, 125.0, 22.0]}},
            {"box": {"id": "obj-29", "maxclass": "comment", "varname": "cs_scale_label", "text": "scale", "numinlets": 1, "numoutlets": 0, "patching_rect": [965.0, 18.0, 65.0, 20.0]}},
            ...
            {"box": {"id": "obj-40", "maxclass": "dial", "varname": "cs_density_dial", "numinlets": 1, "numoutlets": 2, "outlettype": ["int", "bang"], "size": 101, "parameter_enable": 0, "patching_rect": [655.0, 102.0, 48.0, 48.0]}},
            {"box": {"id": "obj-41", "maxclass": "comment", "varname": "cs_density_label", "text": "density %", "numinlets": 1, "numoutlets": 0, "patching_rect": [655.0, 78.0, 80.0, 20.0]}},
            ...
            {"box": {"id": "obj-80", "maxclass": "umenu", "varname": "cs_melody_low_menu", "numinlets": 1, "numoutlets": 3, "outlettype": ["int", "", ""], "patching_rect": [755.0, 102.0, 75.0, 22.0]}},
            {"box": {"id": "obj-81", "maxclass": "comment", "varname": "cs_melody_low_label", "text": "low note", "numinlets": 1, "numoutlets": 0, "patching_rect": [755.0, 78.0, 75.0, 20.0]}},
            {"box": {"id": "obj-82", "maxclass": "newobj", "text": "prepend melodylow", "numinlets": 1, "numoutlets": 1, "outlettype": [""], "patching_rect": [790.0, 640.0, 120.0, 22.0]}},

            {"box": {"id": "obj-83", "maxclass": "umenu", "varname": "cs_melody_high_menu", "numinlets": 1, "numoutlets": 3, "outlettype": ["int", "", ""], "patching_rect": [850.0, 102.0, 75.0, 22.0]}},
            {"box": {"id": "obj-84", "maxclass": "comment", "varname": "cs_melody_high_label", "text": "high note", "numinlets": 1, "numoutlets": 0, "patching_rect": [850.0, 78.0, 75.0, 20.0]}},
            {"box": {"id": "obj-85", "maxclass": "newobj", "text": "prepend melodyhigh", "numinlets": 1, "numoutlets": 1, "outlettype": [""], "patching_rect": [920.0, 640.0, 125.0, 22.0]}},

            {"box": {"id": "obj-86", "maxclass": "umenu", "varname": "cs_pad_count_menu", "numinlets": 1, "numoutlets": 3, "outlettype": ["int", "", ""], "patching_rect": [755.0, 102.0, 85.0, 22.0]}},
            {"box": {"id": "obj-87", "maxclass": "comment", "varname": "cs_pad_count_label", "text": "pad count", "numinlets": 1, "numoutlets": 0, "patching_rect": [755.0, 78.0, 85.0, 20.0]}},
            {"box": {"id": "obj-88", "maxclass": "newobj", "text": "prepend padcount", "numinlets": 1, "numoutlets": 1, "outlettype": [""], "patching_rect": [1055.0, 640.0, 115.0, 22.0]}},
            ...
            {"box": {"id": "obj-76", "maxclass": "comment", "varname": "cs_scale_note", "text": "Manual scale for now. Live global scale follow is a next integration step.", "numinlets": 1, "numoutlets": 0, "patching_rect": [585.0, 165.0, 470.0, 22.0]}}
            ,
            ...
            ,
            {"box": {"id": "obj-79", "maxclass": "newobj", "text": "delay 50", "numinlets": 2, "numoutlets": 1, "outlettype": ["bang"], "patching_rect": [30.0, 360.0, 60.0, 22.0]}}
            ,
            {"box": {"id": "obj-89", "maxclass": "newobj", "text": "delay 120", "numinlets": 2, "numoutlets": 1, "outlettype": ["bang"], "patching_rect": [390.0, 260.0, 70.0, 22.0]}}
        ],
        "lines": [
            {"patchline": {"source": ["obj-1", 0], "destination": ["obj-79", 0]}},
            {"patchline": {"source": ["obj-79", 0], "destination": ["obj-2", 0]}},
            {"patchline": {"source": ["obj-1", 0], "destination": ["obj-9", 0]}},
            {"patchline": {"source": ["obj-79", 0], "destination": ["obj-23", 0]}},
            {"patchline": {"source": ["obj-79", 0], "destination": ["obj-27", 0]}},
            {"patchline": {"source": ["obj-79", 0], "destination": ["obj-31", 0]}},
            {"patchline": {"source": ["obj-79", 0], "destination": ["obj-35", 0]}},
            {"patchline": {"source": ["obj-79", 0], "destination": ["obj-39", 0]}},
            {"patchline": {"source": ["obj-79", 0], "destination": ["obj-43", 0]}},
            ...
            {"patchline": {"source": ["obj-2", 6], "destination": ["obj-80", 0]}},
            {"patchline": {"source": ["obj-2", 7], "destination": ["obj-83", 0]}},
            {"patchline": {"source": ["obj-2", 8], "destination": ["obj-86", 0]}},
            ...
            {"patchline": {"source": ["obj-38", 0], "destination": ["obj-65", 0]}},
            ...
            {"patchline": {"source": ["obj-80", 1], "destination": ["obj-82", 0]}},
            {"patchline": {"source": ["obj-82", 0], "destination": ["obj-2", 0]}},
            {"patchline": {"source": ["obj-83", 1], "destination": ["obj-85", 0]}},
            {"patchline": {"source": ["obj-85", 0], "destination": ["obj-2", 0]}},
            {"patchline": {"source": ["obj-86", 1], "destination": ["obj-88", 0]}},
            {"patchline": {"source": ["obj-88", 0], "destination": ["obj-2", 0]}},

            {"patchline": {"source": ["obj-44", 0], "destination": ["obj-46", 0]}},
            {"patchline": {"source": ["obj-46", 0], "destination": ["obj-3", 0]}},
            {"patchline": {"source": ["obj-77", 0], "destination": ["obj-89", 0]}},
            {"patchline": {"source": ["obj-89", 0], "destination": ["obj-46", 0]}},
